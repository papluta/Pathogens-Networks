...
# n1 = norm %>% filter(Year == 2021) %>% select(Sample, DWVB.abs, BQCV.abs, ABPV.abs, SBV.abs)
# n2 = norm %>% filter(Year == 2022) %>% select(Sample, DWVB.abs, BQCV.abs, ABPV.abs, SBV.abs)
# 
# hind.2022 = left_join(hind.2022 %>% select(-c(DWVB.abs:SBV.abs)), n2, by = 'Sample')
# lind.2022 = left_join(lind.2022 %>% select(-c(DWVB.abs:SBV.abs)), n2, by = 'Sample')
# pind.2022 = left_join(pind.2022 %>% select(-c(DWVB.abs:SBV.abs)), n2, by = 'Sample')
# wind.2022 = left_join(wind.2022 %>% select(-c(DWVB.abs:SBV.abs)), n2, by = 'Sample')
# 
# 
# write.csv(hind.2022, file = 'Data/hb_virus_2022.csv', row.names = F)
# write.csv(lind.2022, file = 'Data/bl_virus_2022.csv', row.names = F)
# write.csv(pind.2022, file = 'Data/bp_virus_2022.csv', row.names = F)
# write.csv(wind.2022, file = 'Data/wb_virus_2022.csv', row.names = F)
...
# hind.2021 = left_join(hind.2021 %>% select(-c(DWVB.abs:SBV.abs)), n1, by = 'Sample')
# bind.2021 = left_join(bind.2021 %>% select(-c(DWVB.abs:SBV.abs)), n1, by = 'Sample')
# wind.2021 = left_join(wind.2021 %>% select(-c(DWVB.abs:SBV.abs)), n1, by = 'Sample')
# 
# write.csv(hind.2021, file = 'Data/hb_virus_2021.csv', row.names = F)
# write.csv(bind.2021, file = 'Data/bb_virus_2021.csv', row.names = F)
# write.csv(wind.2021, file = 'Data/wb_virus_2021.csv', row.names = F)
